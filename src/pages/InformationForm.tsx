        ...
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
            <div className="container mx-auto px-4 py-4 md:py-8 max-w-4xl">
                <div className="text-center mb-6 md:mb-8">
                    ...
                    <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-foreground mt-3 md:mt-4">Welcome Central Charm Azores</h2>
                    <p className="text-sm md:text-base text-muted-foreground mt-2 px-2">Please complete the form below for frontier control
                        purposes.</p>
                </div>
